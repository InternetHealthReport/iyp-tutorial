...
1. Find all hostnames in IYP that end with “.gov” and resolve to IPs in RPKI NotFound prefixes.
1. Which ASes host the most popular content but are not tagged as “Content” by BGP.Tools?
1. Find popular domain names managed by authoritative nameservers hosted at UCSD (AS7377) and authoritative nameservers hosted at San Diego Supercomputer Center (AS195).
