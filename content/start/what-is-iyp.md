...
* Citation: If you publish work/tools based on IYP cite the original dataset used (and the [IYP paper](https://www.iijlab.net/en/members/romain/pdf/romain_imc2024.bib)!). A full list of citations can be found in the [acknowledgements](https://github.com/InternetHealthReport/internet-yellow-pages/blob/main/ACKNOWLEDGMENTS.md).
